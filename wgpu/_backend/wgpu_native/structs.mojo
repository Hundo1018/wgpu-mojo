...
struct WGPUChainedStruct(TrivialRegisterPassable):
    var next: OpaquePointer[MutUntrackedOrigin]   # actually WGPUChainedStruct*
    var stype: UInt32
...
struct WGPUDeviceLostCallbackInfo(TrivialRegisterPassable):
    var next_in_chain: OpaquePointer[MutUntrackedOrigin]
    var mode: UInt32
    var callback: OpaquePointer[MutUntrackedOrigin]   # WGPUDeviceLostCallback fn ptr
    var userdata1: OpaquePointer[MutUntrackedOrigin]
    var userdata2: OpaquePointer[MutUntrackedOrigin]
...
struct WGPUQueueWorkDoneCallbackInfo(TrivialRegisterPassable):
    var next_in_chain: OpaquePointer[MutUntrackedOrigin]
    var mode: UInt32
    var callback: OpaquePointer[MutUntrackedOrigin]   # WGPUQueueWorkDoneCallback fn ptr
    var userdata1: OpaquePointer[MutUntrackedOrigin]
    var userdata2: OpaquePointer[MutUntrackedOrigin]
...
struct WGPURequestAdapterCallbackInfo(TrivialRegisterPassable):
    var next_in_chain: OpaquePointer[MutUntrackedOrigin]
    var mode: UInt32
    var callback: OpaquePointer[MutUntrackedOrigin]   # WGPURequestAdapterCallback fn ptr
    var userdata1: OpaquePointer[MutUntrackedOrigin]
    var userdata2: OpaquePointer[MutUntrackedOrigin]
...
struct WGPURequestDeviceCallbackInfo(TrivialRegisterPassable):
    var next_in_chain: OpaquePointer[MutUntrackedOrigin]
    var mode: UInt32
    var callback: OpaquePointer[MutUntrackedOrigin]   # WGPURequestDeviceCallback fn ptr
    var userdata1: OpaquePointer[MutUntrackedOrigin]
    var userdata2: OpaquePointer[MutUntrackedOrigin]
...
struct WGPUUncapturedErrorCallbackInfo(TrivialRegisterPassable):
    var next_in_chain: OpaquePointer[MutUntrackedOrigin]
    var callback: OpaquePointer[MutUntrackedOrigin]   # WGPUUncapturedErrorCallback fn ptr
    var userdata1: OpaquePointer[MutUntrackedOrigin]
    var userdata2: OpaquePointer[MutUntrackedOrigin]
...
struct WGPUSurfaceSourceWaylandSurface(TrivialRegisterPassable):
    var chain: WGPUChainedStruct
    var display: OpaquePointer[MutUntrackedOrigin]
    var surface: OpaquePointer[MutUntrackedOrigin]
...
struct WGPUSurfaceSourceXCBWindow(TrivialRegisterPassable):
    var chain: WGPUChainedStruct
    var connection: OpaquePointer[MutUntrackedOrigin]
    var window: UInt32
...
def wgpu_limits_default() -> WGPULimits:
    ...
    from wgpu._backend.wgpu_native.types import WGPU_LIMIT_U32_UNDEFINED, WGPU_LIMIT_U64_UNDEFINED
    var u32_max: UInt32 = WGPU_LIMIT_U32_UNDEFINED
    var u64_max: UInt64 = WGPU_LIMIT_U64_UNDEFINED
    return WGPULimits(
        null_opaque(),    # next_in_chain
