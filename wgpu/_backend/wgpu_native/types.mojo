"""
wgpu._backend.wgpu_native.types — Low-level C type aliases, enum constants, and bitflags
...
# ---------------------------------------------------------------------------
comptime NullablePointer[T: AnyType] = Optional[Pointer[T, MutUntrackedOrigin]]

comptime WGPUAdapterHandle = OpaquePointer[MutUntrackedOrigin]
comptime WGPUBindGroupHandle = OpaquePointer[MutUntrackedOrigin]
comptime WGPUBindGroupLayoutHandle = OpaquePointer[MutUntrackedOrigin]
comptime WGPUBufferHandle = OpaquePointer[MutUntrackedOrigin]
comptime WGPUCommandBufferHandle = OpaquePointer[MutUntrackedOrigin]
comptime WGPUCommandEncoderHandle = OpaquePointer[MutUntrackedOrigin]
comptime WGPUComputePassEncoderHandle = OpaquePointer[MutUntrackedOrigin]
comptime WGPUComputePipelineHandle = OpaquePointer[MutUntrackedOrigin]
comptime WGPUDeviceHandle = OpaquePointer[MutUntrackedOrigin]
comptime WGPUExternalTextureHandle = OpaquePointer[MutUntrackedOrigin]
comptime WGPUInstanceHandle = OpaquePointer[MutUntrackedOrigin]
comptime WGPUPipelineLayoutHandle = OpaquePointer[MutUntrackedOrigin]
comptime WGPUQuerySetHandle = OpaquePointer[MutUntrackedOrigin]
comptime WGPUQueueHandle = OpaquePointer[MutUntrackedOrigin]
comptime WGPURenderBundleHandle = OpaquePointer[MutUntrackedOrigin]
comptime WGPURenderBundleEncoderHandle = OpaquePointer[MutUntrackedOrigin]
comptime WGPURenderPassEncoderHandle = OpaquePointer[MutUntrackedOrigin]
comptime WGPURenderPipelineHandle = OpaquePointer[MutUntrackedOrigin]
comptime WGPUSamplerHandle = OpaquePointer[MutUntrackedOrigin]
comptime WGPUShaderModuleHandle = OpaquePointer[MutUntrackedOrigin]
comptime WGPUSurfaceHandle = OpaquePointer[MutUntrackedOrigin]
comptime WGPUTextureHandle = OpaquePointer[MutUntrackedOrigin]
comptime WGPUTextureViewHandle = OpaquePointer[MutUntrackedOrigin]
