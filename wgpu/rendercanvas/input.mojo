...
struct InputState(Movable):
    ...
    var _keys_pressed:       Pointer[Bool, MutUntrackedOrigin]
    var _keys_just_pressed:  Pointer[Bool, MutUntrackedOrigin]
    var _keys_just_released: Pointer[Bool, MutUntrackedOrigin]

    # Mouse button state (0..7)
    var _mouse_pressed:       Pointer[Bool, MutUntrackedOrigin]
    var _mouse_just_pressed:  Pointer[Bool, MutUntrackedOrigin]
    var _mouse_just_released: Pointer[Bool, MutUntrackedOrigin]
