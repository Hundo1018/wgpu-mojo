...
def test_offscreen_render_texture_readback() raises:
    ...
    assert_true(pixels[unsafe_offset=0] == UInt8(0))
    assert_true(pixels[unsafe_offset=1] == UInt8(255))
    assert_true(pixels[unsafe_offset=2] == UInt8(0))
    assert_true(pixels[unsafe_offset=3] == UInt8(255))

    assert_true(pixels[unsafe_offset=4] == UInt8(0))
    assert_true(pixels[unsafe_offset=5] == UInt8(255))
    assert_true(pixels[unsafe_offset=6] == UInt8(0))
    assert_true(pixels[unsafe_offset=7] == UInt8(255))

    assert_true(pixels[unsafe_offset=256] == UInt8(0))
    assert_true(pixels[unsafe_offset=257] == UInt8(255))
    assert_true(pixels[unsafe_offset=258] == UInt8(0))
    assert_true(pixels[unsafe_offset=259] == UInt8(255))

    assert_true(pixels[unsafe_offset=260] == UInt8(0))
    assert_true(pixels[unsafe_offset=261] == UInt8(255))
    assert_true(pixels[unsafe_offset=262] == UInt8(0))
    assert_true(pixels[unsafe_offset=263] == UInt8(255))
...
def test_example_texture_sample_upload_readback() raises:
    ...
    assert_true(pixels[unsafe_offset=0] == UInt8(255))
    assert_true(pixels[unsafe_offset=1] == UInt8(0))
    assert_true(pixels[unsafe_offset=2] == UInt8(0))
    assert_true(pixels[unsafe_offset=3] == UInt8(255))
    ...
    assert_true(pixels[unsafe_offset=256] == UInt8(0))
    assert_true(pixels[unsafe_offset=257] == UInt8(0))
    assert_true(pixels[unsafe_offset=258] == UInt8(255))
    assert_true(pixels[unsafe_offset=259] == UInt8(255))

    assert_true(pixels[unsafe_offset=260] == UInt8(255))
    assert_true(pixels[unsafe_offset=261] == UInt8(255))
    assert_true(pixels[unsafe_offset=262] == UInt8(255))
    assert_true(pixels[unsafe_offset=263] == UInt8(255))
